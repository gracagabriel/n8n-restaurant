...
let AuthController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('Autenticação'), (0, common_1.Controller)('auth')];
    ...
    (() => {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Registrar novo usuário' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Fazer login' })];
        _refresh_decorators = [(0, common_1.Post)('refresh'), (0, swagger_1.ApiOperation)({ summary: 'Renovar access token com refresh token' })];
        _getMe_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Post)('me'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Obter dados do usuário logado' })];
